// 1° declara a função
// declaração de função, tipo de escrever função
...
// uso do return, atenção ele tem que ser a ultima linha do bloco de código!
function soma(){
  return 2 +2;
}

// chama uma função dentro da outra
imprimeTexto(soma()); // 4

//alguns retorno de fuunções matematicas já criados pelo JS
